...
// A hexdump(Unix) reimplementation for task 3

#include <stdio.h> // for fopen, ferror, feof, fclose, fgetc
...
int main(int argc, char* argv[]) {
	...
	line_head_size = argc == 3 ? atoi(argv[2]) : LINE_HEAD_SIZE_DEFAULT; // init
